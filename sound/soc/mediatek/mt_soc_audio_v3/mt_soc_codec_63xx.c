...
static const char *sr_function[] = {"Off", "On"};
...
static int SR_default_Get(struct snd_kcontrol *kcontrol,
                          struct snd_ctl_elem_value *ucontrol)
{
    printk("SR44100_Get = %d\n", mBlockSampleRate[AUDIO_ANALOG_DEVICE_OUT_DAC]);
    ucontrol->value.integer.value[0] = mBlockSampleRate[AUDIO_ANALOG_DEVICE_OUT_DAC];
    return 0;
}

static int SR_default_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
    printk("%s(), value = %d\n", __func__, ucontrol->value.enumerated.item[0]);
    mBlockSampleRate[AUDIO_ANALOG_DEVICE_OUT_DAC] = 44100;
...
static const struct soc_enum Audio_DL_Enum[] =
{
    ...
    SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(sr_function), sr_function),
    SOC_ENUM_SINGLE_EXT(ARRAY_SIZE(amp_function), amp_function),
};
...
static const struct snd_kcontrol_new mt6331_snd_controls[] =
{
    ...
    SOC_ENUM_EXT("SR_default_Switch", Audio_DL_Enum[11], SR_default_Get, SR_default_Set),
