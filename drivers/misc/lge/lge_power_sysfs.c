...
__weak struct power_sysfs_array lge_power_sysfs_path[] = {
	...
	{"battery", "check_batt_id_for_aat", "/sys/class/power_supply/battery/check_batt_id_for_aat"},
	...
	{"testmode", "valid_batt_id", "/sys/class/power_supply/battery/check_batt_id_for_aat"},
};
