...
// [LGE_UPDATE_S] [kyunghun.oh@lge.com] [2015-09-16] AT command added for main/sub camera to prevent mixed items
...
// [LGE_UPDATE_E] [kyunghun.oh@lge.com] [2015-09-16] AT command added for main/sub camera to prevent mixed items
/*******************************************************************************
*
********************************************************************************/
...
int iMultiReadReg(u16 a_u2Addr , u8 *a_puBuff , u16 i2cId, u8 number)
{
	...
	mutex_lock(&kdCam_i2c_Mutex);// [LGE_UPDATE] [kyunghun.oh@lge.com] [2015-11-08] Mod_i2c_tranfer_mode_"start_and_stop"_to_"repeated_start"
    ...
    if (i4RetValue != 2) {
		...
		mutex_unlock(&kdCam_i2c_Mutex);// [LGE_UPDATE] [kyunghun.oh@lge.com] [2015-11-08] Mod_i2c_tranfer_mode_"start_and_stop"_to_"repeated_start"
        return -1;
    }
    /*  */
...
int iBurstReadRegI2C(u8 *a_pSendData , u16 a_sizeSendData, u8 * a_pRecvData, u16 a_sizeRecvData, u16 i2cId)
{
    ...
    *((char *)buf+1) = *(a_pSendData+1);
    ...
    msgs[0].ext_flag = ((g_pstI2Cclient->ext_flag) & I2C_MASK_FLAG) | (I2C_RS_FLAG) |I2C_WR_FLAG | I2C_DMA_FLAG;
            ...
            PK_DBG(" Sensor found ID = 0x%x\n", sensorID);
                    ...
                    switch (sensorID) {
                        ...
                        case 0x5670:
                            ...
                            PK_DBG(" Sub Sensor found ID = %d\n", g_subSensor);
                            break;
                        // LGE_CHANGE_S : [2015-09-09] yonghwan.lym@lge.com, Add camera(hi842,hi553)
                        case 0x842:
                            g_mainSensor = 842;
                            PK_DBG(" Main Sensor found ID = %d\n", g_mainSensor);
                            break;
                        ...
                        case 0x553:
                            ...
                            break;
                        #endif
                        // LGE_CHANGE_E : [2015-09-09] yonghwan.lym@lge.com, Add camera(hi842,hi553)
