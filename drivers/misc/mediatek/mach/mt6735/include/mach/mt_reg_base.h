...
#define INTER_SRAM SYSRAM_BASE
#define LGE_RAM_CONSOLE_MEM_VBASE   0xFA000000 // Virtual Address that doesn't use anywhere.
#define LGE_RAM_CONSOLE_MEM_SIZE    0x0003E000 // 248KB
#endif
