...
#endif
*/
int dw9714_af_current_on;//[LGE_UPDATE][kyunghun.oh@lge.com][2015-10-26] DECREASE_AF_TIC_NOISE
...
u32 pinSet[2][8] = {
    ...
    if (On) {
        ...
        if (currSensorName && (0 == strcmp(SENSOR_DRVNAME_S5K5E2YA_MIPI_RAW, currSensorName)))
        {
			...
			dw9714_af_current_on = 1;//[LGE_UPDATE_S][kyunghun.oh@lge.com][2015-10-26] DECREASE_AF_TIC_NOISE
            //AF_VCC
