...
void msg_dma_release()
{
	if(g_dma_buff_va) {
		...
		g_dma_buff_va = NULL;
		g_dma_buff_pa = NULL;
		TOUCH_LOG("[DMA][release] Allocate DMA I2C Buffer release!\n");
	}
}
...
long ft_rw_iic_drv_ioctl(struct file *filp, unsigned
